      ...
      {isLoading ? (
        ...
        <div className=" mx-6 mb-3 border-x-2 border-gray-500 text-lg mt-10 rounded">
          <div className="flex divide-x-2 divide-gray-500 border-y-2 border-gray-500 font-semibold overflow-auto">
            ...
            <div className="flex items-center">
              <div className=" py-2.5 pl-4 w-52">Precio</div>
            </div>
            <div className="flex items-center">
              <div className=" py-2.5 pl-4 w-72">Disponibilidad</div>
            </div>
            <div className="flex items-center">
              <div className=" pl-1.5 w-72">Marca</div>
            </div>
            <div className="flex items-center">
              <div className=" py-2.5 pl-4 w-24">Modelo</div>
            </div>
            <div className="flex items-center">
              <div className=" py-2.5 pl-4">Rating</div>
            </div>
            <div className="flex items-center">
              <div className=" py-2.5 pl-4">Imagen</div>
            </div>
            <div className="flex items-center">
